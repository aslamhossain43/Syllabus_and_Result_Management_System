...
public class CoursesDTO {
	...
	public CoursesDTO(Long id, String course1, String course2, String course3, String course4, String course5,
	...
	public String toString() {
		return "CoursesDTO [id=" + id + ", course1=" + course1 + ", course2=" + course2 + ", course3=" + course3
